...
filterRouter.post('/item', filterController.createFilterItem.bind(filterController));

filterRouter.patch('/:id', filterController.updateFilter.bind(filterController));
filterRouter.patch('/item/:id', filterController.updateFilterItem.bind(filterController));
